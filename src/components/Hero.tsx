...
export default function Hero({ portfolio }: HeroProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden pt-28 pb-12 md:pt-36 md:pb-16">
      {/* Dynamic ambient backdrop light gray spots */}
      <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] bg-zinc-200/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-zinc-100/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6 text-center lg:text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-black text-white px-3 py-1.5 rounded-none border border-black w-fit mx-auto lg:mx-0 text-xs font-mono font-medium tracking-wide"
            >
            ...
            <motion.div
              ...
              className="space-y-3"
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-950 tracking-tight font-sans">
              ...
              <p className="text-xl sm:text-2xl font-semibold text-slate-800 font-sans">
                {portfolio.title}
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl mx-auto lg:mx-0 font-sans"
            >
              {portfolio.bio}
            </motion.p>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <motion.div
              ...
              className="w-full max-w-md bg-[#0d0e11] rounded-2xl overflow-hidden border border-zinc-800 shadow-none relative"
            >
              {/* Terminal header */}
              <div className="bg-[#1a1b21] px-4 py-3 border-b border-zinc-800/80 flex items-center justify-between">
                ...
                <div className="text-xs font-mono text-slate-400 flex items-center space-x-1">
                  ...
                  <span className="font-semibold tracking-wide">sayem-env.sh</span>
                </div>
                <div className="w-4" /> {/* Spacer */}
              </div>

              {/* Terminal output */}
              <div className="p-6 font-mono text-xs sm:text-sm space-y-4 bg-[#0d0e11] leading-relaxed min-h-[250px]">
                <div>
                  <span className="text-emerald-400">~</span> <span className="text-cyan-400 font-bold">whoami</span>
                  <p className="text-slate-300 mt-1">Sodiol Sayem | Creative Full-Stack Engineer & Designer.</p>
                </div>
                <div>
                  <span className="text-emerald-400">~</span> <span className="text-cyan-400 font-bold">cat core_values.json</span>
                  <pre className="text-slate-300 mt-1 overflow-x-auto font-medium bg-[#13151a] p-3 rounded-none border border-zinc-800/50">
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-4 md:gap-6 pt-16 mt-8 border-t border-slate-200/60"
        >
